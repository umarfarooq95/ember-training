...
<head>
    <meta charset="utf-8">
    <title>DS.PromiseArray - The ember-data API</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/addon_-private_system_promise-proxies.js.html#l9"><code>addon&#x2F;-private&#x2F;system&#x2F;promise-proxies.js:9</code></a>
        </div>
...
<div class="box intro">
    <p>A <code>PromiseArray</code> is an object that acts like both an <code>Ember.Array</code>
...
documentation</a>.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-javascript">let promiseArray = DS.PromiseArray.create({
