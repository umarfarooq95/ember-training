...
<head>
    <meta charset="utf-8">
    <title>DS.Errors - The ember-data API</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/addon_-private_system_model_errors.js.html#l11"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:11</code></a>
        </div>
...
<div class="box intro">
    <p>Holds validation errors for a given record, organized by attribute names.</p>
...
<pre class="code prettyprint"><code class="language-javascript">let user = store.createRecord('user', {
  username: 'tomster',
  email: 'invalidEmail'
});
user.save();
            ...
            <h2 class="off-left">Item Index</h2>
                ...
                <div class="index-section methods">
                    ...
                    <ul class="index-list methods extends">
                            ...
                            <li class="index-item method private">
                                <a href="#method__findOrCreateMessages">_findOrCreateMessages</a>

                            </li>
                            <li class="index-item method private">
                                <a href="#method__registerHandlers">_registerHandlers</a>

                            </li>
                            <li class="index-item method private">
                                <a href="#method__remove">_remove</a>
                            ...
                            <li class="index-item method">
                                <a href="#method_errorsFor">errorsFor</a>
                            ...
                            <li class="index-item method private">
                                <a href="#method_unknownProperty">unknownProperty</a>
                ...
                <div class="index-section properties">
                    ...
                    <ul class="index-list properties extends">
                            ...
                            <li class="index-item property private">
                                <a href="#property_errorsByAttributeName">errorsByAttributeName</a>
                            ...
                            <li class="index-item property">
                                <a href="#property_length">length</a>
...
<div id="method__add" class="method item private">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l233"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:233</code></a>
        </p>
    ...
    <div class="description">
        <p>Adds error messages to a given attribute without sending event.</p>
...
<div id="method__clear" class="method item private">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l377"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:377</code></a>
        </p>
...
<div id="method__findOrCreateMessages" class="method item private">
    <h3 class="name"><code>_findOrCreateMessages</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l248"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:248</code></a>
        </p>
...
<div id="method__registerHandlers" class="method item private">
    <h3 class="name"><code>_registerHandlers</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l86"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:86</code></a>
        </p>
    ...
    <div class="description">
        <p>Register with target handler</p>
...
<div id="method__remove" class="method item private">
    <h3 class="name"><code>_remove</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l311"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:311</code></a>
        </p>
    ...
    <div class="description">
        <p>Removes all error messages from the given attribute without sending event.</p>
...
<div id="method_add" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l187"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:187</code></a>
        </p>
    ...
    <div class="description">
        <p>Manually adds errors to the record. This will triger the <code>becameInvalid</code> event/ lifecycle method on
the record and transition the record into an <code>invalid</code> state.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-javascript"> let errors = get(user, 'errors');
...
<li>the property name of an attribute or relationship</li>
                ...
                <li class="param">
                        <code class="param-name">messages</code>
...
<div id="method_errorsFor" class="method item">
    <h3 class="name"><code>errorsFor</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l106"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:106</code></a>
        </p>
    ...
    <div class="description">
        <p>Returns errors for a given attribute</p>
<pre class="code prettyprint"><code class="language-javascript">let user = store.createRecord('user', {
  username: 'tomster',
  email: 'invalidEmail'
});
...
<div id="method_has" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l404"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:404</code></a>
        </p>
    ...
    <div class="description">
        <p>Checks if there are error messages for the given attribute.</p>
<pre class="code prettyprint"><code class="language-app/routes/user/edit.js">import Route from '@ember/routing/route';
    ...
    save: function(user) {
      ...
      user.save();
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Boolean</span>:
                    <p>true if there some errors on given attribute</p>
...
<div id="method_remove" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l273"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:273</code></a>
        </p>
    ...
    <div class="description">
        <p>Manually removes all errors for a given member from the record.
...
<pre class="code prettyprint"><code class="language-javascript"> let errors = get('user', errors);
 ...
 // =&gt; undefined
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name">member</code>
                        <span class="type">String</span>
...
<div id="method_remove" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l330"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:330</code></a>
        </p>
    ...
    <div class="description">
        <p>Manually clears all errors for the record.
This will transition the record into a <code>valid</code> state, and
...
<div id="method_unknownProperty" class="method item private">
    <h3 class="name"><code>unknownProperty</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l160"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:160</code></a>
        </p>
...
<div id="property_content" class="property item private">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l151"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:151</code></a>
        </p>
...
<div id="property_errorsByAttributeName" class="property item private">
    <h3 class="name"><code>errorsByAttributeName</code></h3>
    <span class="type">MapWithDefault</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l97"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:97</code></a>
        </p>
...
<div id="property_isEmpty" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l180"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:180</code></a>
        </p>
...
<div id="property_length" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l172"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:172</code></a>
        </p>
...
<div id="property_messages" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_model_errors.js.html#l134"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;errors.js:134</code></a>
        </p>
    ...
    <div class="description">
        <p>An array containing all of the error messages for this
