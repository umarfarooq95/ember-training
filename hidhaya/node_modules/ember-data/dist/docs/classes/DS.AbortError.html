...
<head>
    <meta charset="utf-8">
    <title>DS.AbortError - The ember-data API</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/addon_-private_adapters_errors.js.html#l222"><code>addon&#x2F;-private&#x2F;adapters&#x2F;errors.js:222</code></a>
        </div>
...
<div class="box intro">
    <p>A <code>DS.AbortError</code> is used by an adapter to signal that a request to
the external API was aborted. For example, this can occur if the user
navigates away from the current page after a request to the external API
has been initiated but before a response has been received.</p>
