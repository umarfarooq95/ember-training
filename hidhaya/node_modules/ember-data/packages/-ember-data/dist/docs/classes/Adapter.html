...
<head>
    <meta charset="utf-8">
    <title>Adapter - The ember-data API</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/.._adapter_addon_index.js.html#l10"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:10</code></a>
        </div>
...
<div class="box intro">
    <p>An adapter is an object that receives requests from a store and
...
<p>Create a new subclass of <code>Adapter</code> in the <code>app/adapters</code> folder:</p>
...
<pre class="code prettyprint"><code class="language-app/adapters/post.js">import Adapter from '@ember-data/adapter';

export default Adapter.extend({
  // ...Post-specific adapter code goes here
});
</code></pre>
<p><code>Adapter</code> is an abstract base class that you should override in your
...
<p>For an example of the implementation, see <code>RESTAdapter</code>, the
...
<div id="method_createRecord" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._adapter_addon_index.js.html#l288"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:288</code></a>
        </p>
    ...
    <div class="description">
        <p>Implement this method in a subclass to handle the creation of
new records.</p>
...
<div id="method_deleteRecord" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._adapter_addon_index.js.html#l383"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:383</code></a>
        </p>
    ...
    <div class="description">
        <p>Implement this method in a subclass to handle the deletion of
a record.</p>
...
export default Adapter.extend({
  deleteRecord(store, type, snapshot) {
    ...
    return new RSVP.Promise(function(resolve, reject) {
      $.ajax({
        type: 'DELETE',
        url: <code>&#x2F;${type.modelName}&#x2F;${id}</code>,
        dataType: 'json',
        data: data
      }).then(function(data) {
        run(null, resolve, data);
...
<div id="method_findAll" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._adapter_addon_index.js.html#l125"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:125</code></a>
        </p>
    ...
    <div class="description">
        <p>The <code>findAll()</code> method is used to retrieve all records for a given type.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-app/adapters/application.js">import Adapter from '@ember-data/adapter';
import RSVP from 'RSVP';
import $ from 'jquery';
...
export default Adapter.extend({
  findAll(store, type) {
    return new RSVP.Promise(function(resolve, reject) {
      $.getJSON(<code>&#x2F;${type.modelName}</code>).then(function(data) {
        resolve(data);
      }, function(jqXHR) {
        reject(jqXHR);
      });
...
<div id="method_findMany" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._adapter_addon_index.js.html#l438"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:438</code></a>
        </p>
    ...
    <div class="description">
        <p>The store will call <code>findMany</code> instead of multiple <code>findRecord</code>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>the Model class of the records</p>
...
<div id="method_findRecord" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._adapter_addon_index.js.html#l89"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:89</code></a>
        </p>
    ...
    <div class="description">
        <p>The <code>findRecord()</code> method is invoked when the store is asked for a record that
...
export default Adapter.extend({
  findRecord(store, type, id, snapshot) {
    return new RSVP.Promise(function(resolve, reject) {
      $.getJSON(<code>&#x2F;${type.modelName}&#x2F;${id}</code>).then(function(data) {
        resolve(data);
      }, function(jqXHR) {
        reject(jqXHR);
      });
...
<div id="method_generateIdForRecord" class="method item">
...
<div id="method_groupRecordsForFindMany" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._adapter_addon_index.js.html#l477"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:477</code></a>
        </p>
...
<div id="method_query" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._adapter_addon_index.js.html#l157"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:157</code></a>
        </p>
    ...
    <div class="description">
        <p>This method is called when you call <code>query</code> on the store.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-app/adapters/application.js">import Adapter from '@ember-data/adapter';
import RSVP from 'RSVP';
import $ from 'jquery';
...
export default Adapter.extend({
  query(store, type, query) {
    return new RSVP.Promise(function(resolve, reject) {
      $.getJSON(<code>&#x2F;${type.modelName}</code>, query).then(function(data) {
        resolve(data);
      }, function(jqXHR) {
        reject(jqXHR);
      });
        ...
        <div class="params">
            ...
            <ul class="params-list">
                ...
                <li class="param">
                        <code class="param-name">recordArray</code>
                        <span class="type"><a href="../classes/AdapterPopulatedRecordArray.html" class="crosslink">AdapterPopulatedRecordArray</a></span>
...
<div id="method_queryRecord" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._adapter_addon_index.js.html#l189"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:189</code></a>
        </p>
    ...
    <div class="description">
        <p>The <code>queryRecord()</code> method is invoked when the store is asked for a single
...
<p>Example</p>
<pre class="code prettyprint"><code class="language-app/adapters/application.js">import Adapter, { BuildURLMixin } from '@ember-data/adapter';
import RSVP from 'RSVP';
import $ from 'jquery';
      ...
      $.getJSON(<code>&#x2F;${type.modelName}</code>, query).then(function(data) {
        ...
        <div class="params">
            ...
            <ul class="params-list">
                ...
                <li class="param">
                        <code class="param-name">type</code>
                        <span class="type">Subclass of Model</span>
...
<div id="method_shouldBackgroundReloadAll" class="method item">
...
<div id="method_shouldBackgroundReloadRecord" class="method item">
...
<div id="method_shouldReloadAll" class="method item">
...
<div id="method_shouldReloadRecord" class="method item">
...
<div id="method_updateRecord" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._adapter_addon_index.js.html#l331"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:331</code></a>
        </p>
    ...
    <div class="description">
        <p>Implement this method in a subclass to handle the updating of
a record.</p>
...
<div id="property_coalesceFindRequests" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._adapter_addon_index.js.html#l427"><code>..&#x2F;adapter&#x2F;addon&#x2F;index.js:427</code></a>
        </p>
    ...
    <div class="description">
        <p>By default the store will try to coalesce all <code>fetchRecord</code> calls within the same runloop
...
<div id="property_defaultSerializer" class="property item deprecated">
