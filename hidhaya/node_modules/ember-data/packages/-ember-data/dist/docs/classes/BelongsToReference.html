...
<head>
    <meta charset="utf-8">
    <title>BelongsToReference - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>BelongsToReference Class</h1>
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/.._store_addon_-private_system_references_belongs-to.js.html#l11"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;belongs-to.js:11</code></a>
        </div>
...
<div class="box intro">
    <p>A <code>BelongsToReference</code> is a low-level API that allows users and
...
<div id="method_id" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_references_belongs-to.js.html#l31"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;belongs-to.js:31</code></a>
        </p>
    ...
    <div class="description">
        <p>The <code>id</code> of the record that this reference refers to. Together, the
   ...
   let id = userRef.id();
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type"><a href="../classes/String.html" class="crosslink">String</a></span>:
                    <p>The id of the record in this belongsTo relationship.</p>
...
<div id="method_load" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_references_belongs-to.js.html#l214"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;belongs-to.js:214</code></a>
        </p>
    ...
    <div class="description">
        <p>Loads a record in a belongs-to relationship if it is not already
...
<p>Example</p>
<pre class="code prettyprint"><code class="language-javascript">userRef.load({ adapterOptions: { isPrivate: true } }).then(function(user) {
  userRef.value() === user;
});
</code></pre>
<pre class="code prettyprint"><code class="language-app/adapters/user.js">export default ApplicationAdapter.extend({
  findRecord(store, type, id, snapshot) {
    ...
    let adapterOptions = snapshot.adapterOptions;
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>a promise that resolves with the record in this belongs-to relationship.</p>
...
<div id="method_push" class="method item">
    <h3 class="name"><code>push</code></h3>
        ...
        <span class="returns-inline">
            <span class="type">Promise<record></span>
        </span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_references_belongs-to.js.html#l81"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;belongs-to.js:81</code></a>
        </p>
...
<p>Example</p>
<pre class="code prettyprint"><code class="language-app/models/blog.js">import Model, { belongsTo } from '@ember-data/model';
...
userRef.push({
   ...
   userRef.value() === user;
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise<record></span>:
                    <p>A promise that resolves with the new value in this belongs-to relationship.</p>
...
<div id="method_reload" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_references_belongs-to.js.html#l278"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;belongs-to.js:278</code></a>
        </p>
    ...
    <div class="description">
        <p>Triggers a reload of the value in this relationship. If the
...
<p>Example</p>
<pre class="code prettyprint"><code class="language-javascript">userRef.reload({ adapterOptions: { isPrivate: true } })
</code></pre>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>a promise that resolves with the record in this belongs-to relationship after the reload has completed.</p>
...
<div id="method_remoteType" class="method item inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Reference.html#method_remoteType">Reference</a>:
        <a href="../files/.._store_addon_-private_system_references_reference.ts.html#l44"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;reference.ts:44</code></a>
        </p>
...
<div id="method_value" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_references_belongs-to.js.html#l152"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;belongs-to.js:152</code></a>
        </p>
    ...
    <div class="description">
        <p><code>value()</code> synchronously returns the current value of the belongs-to
...
userRef.push({
   ...
   userRef.value(); // user
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type"><a href="../classes/Model.html" class="crosslink">Model</a></span>:
                    <p>the record in this relationship</p>
