...
<head>
    <meta charset="utf-8">
    <title>SnapshotRecordArray - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>SnapshotRecordArray Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l5"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:5</code></a>
        </div>
...
<div class="box intro">
    ...
    <div class="constructor">
        <h2>Constructor</h2>
<div id="method_SnapshotRecordArray" class="method item private">
    <h3 class="name"><code>SnapshotRecordArray</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l5"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:5</code></a>
        </p>
                ...
                <div class="index-section methods">
                    ...
                    <ul class="index-list methods">
                            <li class="index-item method">
                                <a href="#method_snapshots">snapshots</a>
                ...
                <div class="index-section properties">
                    ...
                    <ul class="index-list properties">
                            <li class="index-item property private">
                                <a href="#property__recordArray">_recordArray</a>

                            </li>
                            <li class="index-item property private">
                                <a href="#property__snapshots">_snapshots</a>
                            ...
                            <li class="index-item property">
                                <a href="#property_include">include</a>
...
<div id="method_snapshots" class="method item">
    <h3 class="name"><code>snapshots</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l137"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:137</code></a>
        </p>
    ...
    <div class="description">
        <p>Get snapshots of the underlying record array</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-app/adapters/post.js">import JSONAPIAdapter from '@ember-data/adapter/json-api';
...
<div id="property__recordArray" class="property item private">
    <h3 class="name"><code>_recordArray</code></h3>
    <span class="type">Array</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l22"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:22</code></a>
        </p>
...
<div id="property__snapshots" class="property item private">
    <h3 class="name"><code>_snapshots</code></h3>
    <span class="type">Array</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l14"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:14</code></a>
        </p>
...
<div id="property_adapterOptions" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l74"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:74</code></a>
        </p>
    ...
    <div class="description">
        <p>A hash of adapter options passed into the store method for this request.</p>
<p>Example</p>
...
<div id="property_include" class="property item">
    <h3 class="name"><code>include</code></h3>
    <span class="type"><a href="../classes/String.html" class="crosslink">String</a> | Array</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l97"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:97</code></a>
        </p>
    ...
    <div class="description">
        <p>The relationships to include for this request.</p>
<p>Example</p>
...
export default Adapter.extend({
  findAll(store, type, snapshotRecordArray) {
    var url = <code>&#x2F;${type.modelName}?include=${encodeURIComponent(snapshotRecordArray.include)}</code>;
...
<div id="property_length" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l30"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:30</code></a>
        </p>
    ...
    <div class="description">
        <p>Number of records in the array</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-app/adapters/post.js">import JSONAPIAdapter from '@ember-data/adapter/json-api';
...
<div id="property_meta" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l52"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:52</code></a>
        </p>
    ...
    <div class="description">
        <p>Meta objects for the record array.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-app/adapters/post.js">import JSONAPIAdapter from '@ember-data/adapter/json-api';
...
<div id="property_type" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l120"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:120</code></a>
        </p>
    ...
    <div class="description">
        <p>The type of the underlying records for the snapshots in the array, as a Model</p>
...
<div id="property_type" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_snapshot-record-array.js.html#l128"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;snapshot-record-array.js:128</code></a>
        </p>
    ...
    <div class="description">
        <p>The modelName of the underlying records for the snapshots in the array, as a Model</p>
