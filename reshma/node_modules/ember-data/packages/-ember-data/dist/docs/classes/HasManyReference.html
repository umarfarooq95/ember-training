...
<head>
    <meta charset="utf-8">
    <title>HasManyReference - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>HasManyReference Class</h1>
<div class="box meta">

        <div class="extends">
            Extends <a href="../classes/Reference.html" class="crosslink">Reference</a>
        </div>

        <div class="foundat">
            Defined in: <a href="../files/.._store_addon_-private_system_references_has-many.js.html#l12"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;has-many.js:12</code></a>
        </div>
...
<div class="box intro">
    <p>A <code>HasManyReference</code> is a low-level API that allows users and addon
                ...
                <div class="index-section methods">
                    ...
                    <ul class="index-list methods extends">
                            <li class="index-item method">
                                <a href="#method_ids">ids</a>

                            </li>
                            <li class="index-item method inherited">
                                <a href="#method_link">link</a>
                            ...
                            <li class="index-item method inherited">
                                <a href="#method_remoteType">remoteType</a>
...
<div id="method_ids" class="method item">
    <h3 class="name"><code>ids</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_references_has-many.js.html#l84"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;has-many.js:84</code></a>
        </p>
    ...
    <div class="description">
        <p><code>ids()</code> returns an array of the record IDs in this relationship.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-app/models/post.js">import Model, { hasMany } from '@ember-data/model';
export default Model.extend({
  comments: hasMany({ async: true })
});
</code></pre>
<pre class="code prettyprint"><code class="language-javascript">let post = store.push({
  data: {
    type: 'post',
    id: 1,
    relationships: {
...
commentsRef.ids(); // ['1']
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Array</span>:
                    <p>The ids in this has-many relationship</p>
...
<div id="method_link" class="method item inherited">
    <h3 class="name"><code>link</code></h3>
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Reference.html#method_link">Reference</a>:
        <a href="../files/.._store_addon_-private_system_references_reference.ts.html#l93"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;reference.ts:93</code></a>
        </p>
...
<div id="method_load" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_references_has-many.js.html#l260"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;has-many.js:260</code></a>
        </p>
    ...
    <div class="description">
        <p>Loads the relationship if it is not already loaded.  If the
...
<p>Example</p>
<pre class="code prettyprint"><code class="language-javascript">commentsRef.load({ adapterOptions: { isPrivate: true } })
  .then(function(comments) {
    //...
  });
</code></pre>
<pre class="code prettyprint"><code class="language-app/adapters/comment.js">export default ApplicationAdapter.extend({
  findMany(store, type, id, snapshots) {
    ...
    let adapterOptions = snapshots[0].adapterOptions;
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>a promise that resolves with the ManyArray in
this has-many relationship.</p>
...
<div id="method_meta" class="method item inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/Reference.html#method_meta">Reference</a>:
        <a href="../files/.._store_addon_-private_system_references_reference.ts.html#l143"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;reference.ts:143</code></a>
        </p>
...
<div id="method_push" class="method item">
    <h3 class="name"><code>push</code></h3>
        ...
        <div class="args">
            <span class="paren">(</span><ul class="args-list inline commas">
                <li class="arg">
                        <code>objectOrPromise</code>
                </li>
            </ul><span class="paren">)</span>
        </div>

        <span class="returns-inline">
            <span class="type"><a href="../classes/ManyArray.html" class="crosslink">ManyArray</a></span>
        </span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_references_has-many.js.html#l128"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;has-many.js:128</code></a>
        </p>
    ...
    <div class="description">
        <p><code>push</code> can be used to update the data in the relationship and Ember
...
<pre class="code prettyprint"><code>let post = store.push({
  data: {
    type: 'post',
    id: 1,
    relationships: {
...
commentsRef.ids(); // ['2', '3']
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name">objectOrPromise</code>
                        <span class="type">Array | Promise</span>


                    <div class="param-description">
                        <p>a promise that resolves to a JSONAPI document object describing the new value of this relationship.</p>
...
<div id="method_reload" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_references_has-many.js.html#l326"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;has-many.js:326</code></a>
        </p>
    ...
    <div class="description">
        <p>Reloads this has-many relationship. This causes a request to the specified
relationship link or reloads all items currently in the relationship.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-app/models/post.js">import Model, { hasMany } from '@ember-data/model';
export default Model.extend({
...
<p>Example</p>
<pre class="code prettyprint"><code class="language-javascript">commentsRef.reload({ adapterOptions: { isPrivate: true } })
</code></pre>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type">Promise</span>:
                    <p>a promise that resolves with the ManyArray in this has-many relationship.</p>
...
<div id="method_remoteType" class="method item">
    <h3 class="name"><code>remoteType</code></h3>
    ...
    <div class="meta">
            <p>Inherited from
            <a href="../classes/Reference.html#method_remoteType">
                Reference
            </a>
            but overwritten in
        <a href="../files/.._store_addon_-private_system_references_has-many.js.html#l35"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;has-many.js:35</code></a>
        </p>
    ...
    <div class="description">
        <p>This returns a string that represents how the reference will be
...
if (commentsRef.remoteType() === &quot;ids&quot;) {
  ...
  let link = commentsRef.link();
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type"><a href="../classes/String.html" class="crosslink">String</a></span>:
                    <p>The name of the remote type. This should either be <code>link</code> or <code>ids</code></p>
...
<div id="method_value" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._store_addon_-private_system_references_has-many.js.html#l213"><code>..&#x2F;store&#x2F;addon&#x2F;-private&#x2F;system&#x2F;references&#x2F;has-many.js:213</code></a>
        </p>
    ...
    <div class="description">
        <p><code>value()</code> synchronously returns the current value of the has-many
