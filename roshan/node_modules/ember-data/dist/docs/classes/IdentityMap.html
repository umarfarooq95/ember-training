...
<head>
    <meta charset="utf-8">
    <title>IdentityMap - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>IdentityMap Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/addon_-private_system_identity-map.ts.html#l4"><code>addon&#x2F;-private&#x2F;system&#x2F;identity-map.ts:4</code></a>
        </div>
...
<div class="box intro">
    <p><code>IdentityMap</code> is a custom storage map for records by modelName
used by <code>DS.Store</code>.</p>
...
<div id="method_clear" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_identity-map.ts.html#l33"><code>addon&#x2F;-private&#x2F;system&#x2F;identity-map.ts:33</code></a>
        </p>
    ...
    <div class="description">
        <p>Clears the contents of all known <code>RecordMaps</code>, but does
...
<div id="method_diffArray" class="method item private">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_diff-array.js.html#l1"><code>addon&#x2F;-private&#x2F;system&#x2F;diff-array.js:1</code></a>
        </p>
...
<div id="method_retrieve" class="method item">
    <h3 class="name"><code>retrieve</code></h3>
        ...
        <span class="returns-inline">
            <span class="type"><a href="../classes/InternalModelMap.html" class="crosslink">InternalModelMap</a></span>
        </span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_identity-map.ts.html#l14"><code>addon&#x2F;-private&#x2F;system&#x2F;identity-map.ts:14</code></a>
        </p>
    ...
    <div class="description">
        <p>Retrieves the <code>InternalModelMap</code> for a given modelName,
...
similar to <code>getWithDefault</code> or <code>get</code> on a <code>MapWithDefault</code></p>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>a previously normalized modelName</p>
        ...
        <div class="returns">
            ...
            <div class="returns-description">
                        <span class="type"><a href="../classes/InternalModelMap.html" class="crosslink">InternalModelMap</a></span>:
                    <p>the InternalModelMap for the given modelName</p>
