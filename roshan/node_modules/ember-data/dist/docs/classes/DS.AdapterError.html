...
<head>
    <meta charset="utf-8">
    <title>DS.AdapterError - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>DS.AdapterError Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/addon_-private_adapters_errors.js.html#l10"><code>addon&#x2F;-private&#x2F;adapters&#x2F;errors.js:10</code></a>
        </div>
...
<pre class="code prettyprint"><code class="language-app/adapters/maintenance-error.js">import DS from 'ember-data';
...
<pre class="code prettyprint"><code class="language-app/routes/application.js">import Route from '@ember/routing/route';
