...
<head>
    <meta charset="utf-8">
    <title>DS.BooleanTransform - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>DS.BooleanTransform Class</h1>
<div class="box meta">

        <div class="extends">
            Extends <a href="../classes/DS.Transform.html" class="crosslink">DS.Transform</a>
        </div>

        <div class="foundat">
            Defined in: <a href="../files/addon_transforms_boolean.js.html#l4"><code>addon&#x2F;transforms&#x2F;boolean.js:4</code></a>
        </div>
...
<div class="box intro">
    <p>The <code>DS.BooleanTransform</code> class is used to serialize and deserialize
...
<div id="method_deserialize" class="method item inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/DS.Transform.html#method_deserialize">DS.Transform</a>:
        ...
        <div class="params">
            ...
            <ul class="params-list">
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        hash of options passed to <code>DS.attr</code>
                    </div>
...
<div id="method_serialize" class="method item inherited">
    ...
    <div class="meta">
                <p>Inherited from
                <a href="../classes/DS.Transform.html#method_serialize">DS.Transform</a>:
