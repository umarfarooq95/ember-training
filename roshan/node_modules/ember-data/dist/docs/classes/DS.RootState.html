...
<head>
    <meta charset="utf-8">
    <title>DS.RootState - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>DS.RootState Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/addon_-private_system_model_states.js.html#l10"><code>addon&#x2F;-private&#x2F;system&#x2F;model&#x2F;states.js:10</code></a>
        </div>
...
<pre class="code prettyprint"><code class="language-javascript">aState: DS.State.create({
