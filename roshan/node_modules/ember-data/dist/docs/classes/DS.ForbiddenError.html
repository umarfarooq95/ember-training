...
<head>
    <meta charset="utf-8">
    <title>DS.ForbiddenError - The ember-data API</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/addon_-private_adapters_errors.js.html#l270"><code>addon&#x2F;-private&#x2F;adapters&#x2F;errors.js:270</code></a>
        </div>
...
<div class="box intro">
    <p>A <code>DS.ForbiddenError</code> equates to a HTTP <code>403 Forbidden</code> response status.
It is used by an adapter to signal that a request to the external API was
valid but the server is refusing to respond to it. If authorization was
provided and is valid, then the authenticated user does not have the
necessary permissions for the request.</p>
