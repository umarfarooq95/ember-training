...
<head>
    <meta charset="utf-8">
    <title>DS.PromiseObject - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>DS.PromiseObject Class</h1>
<div class="box meta">
        <div class="uses">
            Uses
            <ul class="inline commas">
                    <li><a href="Ember.PromiseProxyMixin.html">Ember.PromiseProxyMixin</a></li>
            </ul>
        </div>
        ...
        <div class="foundat">
            Defined in: <a href="../files/addon_-private_system_promise-proxies.js.html#l42"><code>addon&#x2F;-private&#x2F;system&#x2F;promise-proxies.js:42</code></a>
        </div>
...
<div class="box intro">
    <p>A <code>PromiseObject</code> is an object that acts like both an <code>EmberObject</code>
...
documentation</a>.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-javascript">let promiseObject = DS.PromiseObject.create({
