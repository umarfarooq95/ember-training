...
<head>
    <meta charset="utf-8">
    <title>addon/serializers/json-api.js - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1 class="file-heading">File: addon/serializers/json-api.js</h1>
  ...
  extractAttributes(modelClass, resourceHash) {
    ...
    if (resourceHash.attributes) {
      modelClass.eachAttribute(key =&gt; {
        ...
        if (DEBUG) {
          if (
            resourceHash.attributes[attributeKey] === undefined &amp;&amp;
