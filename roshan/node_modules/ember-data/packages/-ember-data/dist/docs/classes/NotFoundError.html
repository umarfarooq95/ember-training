...
<head>
    <meta charset="utf-8">
    <title>NotFoundError - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>NotFoundError Class</h1>
<div class="box meta">

        <div class="extends">
            Extends <a href="../classes/AdapterError.html" class="crosslink">AdapterError</a>
        </div>

        <div class="foundat">
            Defined in: <a href="../files/.._adapter_addon_error.js.html#l275"><code>..&#x2F;adapter&#x2F;addon&#x2F;error.js:275</code></a>
        </div>
...
<div class="box intro">
    <p>A <code>NotFoundError</code> equates to a HTTP <code>404 Not Found</code> response status.
