...
<head>
    <meta charset="utf-8">
    <title>AdapterError - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>AdapterError Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/.._adapter_addon_error.js.html#l8"><code>..&#x2F;adapter&#x2F;addon&#x2F;error.js:8</code></a>
        </div>
...
<pre class="code prettyprint"><code class="language-app/adapters/maintenance-error.js">import AdapterError from '@ember-data/adapter/error';
