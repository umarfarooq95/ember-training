...
<head>
    <meta charset="utf-8">
    <title>Transform - The ember-data API</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/.._serializer_addon_-private_transforms_transform.js.html#l7"><code>..&#x2F;serializer&#x2F;addon&#x2F;-private&#x2F;transforms&#x2F;transform.js:7</code></a>
        </div>
...
<div class="box intro">
    <p>The <code>Transform</code> class is used to serialize and deserialize model
...
<p>Example</p>
<pre class="code prettyprint"><code class="language-app/transforms/temperature.js">import Transform from '@ember-data/serializer/transform';
...
<p>Usage</p>
<pre class="code prettyprint"><code class="language-app/models/requirement.js">import Model, { attr } from '@ember-data/model';
...
<pre class="code prettyprint"><code class="language-app/models/post.js">import Model, { attr } from '@ember-data/model';
...
<pre class="code prettyprint"><code class="language-app/transforms/markdown.js">import Transform from '@ember-data/serializer/transform';
...
<div id="method_deserialize" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._serializer_addon_-private_transforms_transform.js.html#l99"><code>..&#x2F;serializer&#x2F;addon&#x2F;-private&#x2F;transforms&#x2F;transform.js:99</code></a>
        </p>
    ...
    <div class="description">
        <p>When given a serialized value from a JSON object this method must
return the deserialized value for the record attribute.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-javascript">deserialize(serialized, options) {
  return empty(serialized) ? null : Number(serialized);
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name">serialized</code>
                ...
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>hash of options passed to <code>attr</code></p>
...
<div id="method_serialize" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._serializer_addon_-private_transforms_transform.js.html#l78"><code>..&#x2F;serializer&#x2F;addon&#x2F;-private&#x2F;transforms&#x2F;transform.js:78</code></a>
        </p>
    ...
    <div class="description">
        <p>When given a deserialized value from a record attribute this
method must return the serialized value.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-javascript">import { isEmpty } from '@ember/utils';
...
serialize(deserialized, options) {
  return isEmpty(deserialized) ? null : Number(deserialized);
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                        <code class="param-name">deserialized</code>
                        <span class="type">Object</span>
