...
<head>
    <meta charset="utf-8">
    <title>../record-data/addon/-private/relationships/state/has-many.ts - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1 class="file-heading">File: ../record-data/addon/-private/relationships/state/has-many.ts</h1>
